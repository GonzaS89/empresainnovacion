  ...
  return (
    <section className="bg-grisfondo px-[50px] pb-10 sm:py-12">
        <div className="w-full lg:max-w-7xl h-[800px] flex justify-center relative margin0Auto">
          ...
          <div className="flex sm:h-[800px] sm:w-3/4 h-[650px] lg:h-[700px] bg-azulfuerte absolute z-40 bottom-0 lg:bottom-auto sm:right-0 sm:top-0 rounded-3xl">
            <div className="w-full h-full flex flex-col justify-evenly lg:flex-row translate-y-[-90px] sm:translate-y-[0] lg:translate-y-[90px] lg:translate-x-[-130px]">
            <span className="bloqueimg rounded-2xl self-end sm:self-auto sm:basis-1/2 lg:basis-full sm:translate-x-[-50px] sm:translate-y-[25px]"></span>
